...
|:------|:--------:|:------|:------|
| v10.2.0|**11/01/26**| Solax & Octopus Settings.yaml (dashboard) <br>  automations_5000-5005.yaml <br> Solax & Octopus Settings.yaml (dashboard) <br> packages\connected_ev_tracking\template_ev_mapper.yaml <br> packages\octopus_dispatches\template_octopus_dispatch.yaml <br> packages/octopus_dispatches/template_hh_offpeak.yaml <br> packages\solax_control\rest_command.yaml <br> packages\solax_loads\powercalc.yaml <br> packages\solax_loads|template_solax_extras.yaml <br> packages\solax_loads\utilitymeter.yaml <br> packages\solax_realtime\templates.yaml| Track battery heating, new binary_sensor for tracking offpeak HH slots during peak times (future automations coming to utilise this sensor) + various improvements/bug fixes to keep logs clean|
