...
|:------|:--------:|:------|:------|
| v7.2.0|**23/11/25**|automations_5000-5005.yaml<br>packages\solax_zappi_octopus_ui\input_button.yaml<br>packages\solax_loads\template_battery_soh.yaml| Removed automation 5003 and replaced with a button on dashboard to apply settings, 5001 was updated to perform the apply setting.|
