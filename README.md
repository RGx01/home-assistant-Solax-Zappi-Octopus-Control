...
|:-----|:--------:|:------|:------|
| v2.1.4 | **29/1/25** | packages/octopus_saving_sessions/input_boolean.yaml <br/> all automations <br/> Octopus Saving Sessions.yaml (Dashboard)| 1. Added new controls to Saving Sessions Dashboard to attempt to get a dispatch during battery prep and also attempt to get a dispatch straight after session.
